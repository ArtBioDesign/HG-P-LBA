...
class BIPLnet(torch.nn.Module):
    def __init__(self,metadata):
        ...
        self.proteingnn = AttentiveFP(in_channels=26,hidden_channels=64,out_channels=16,edge_dim=93,num_timesteps=3,num_layers=3)
...
if __name__ == '__main__':
    ...
    val_loader = DataLoader(dataset=val_set, batch_size=64,shuffle=True, pin_memory=True)
